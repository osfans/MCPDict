...
[薪典深耕版](https://c.syndict.com/zi)：查字使用漢字音典數據，實時更新。
...
漢字音典的語言檔案由 @Resound 建立，負責項目中的語言資料管理。其主要內容包括：語言名稱及簡稱、提交文件名稱、語言行政區劃及地理坐標、聲調（調類、調名、調值）、參考文獻、錄入人、維護人、説明、多種分區信息等。目前檔案僅對參與字表製作的愛好者開放。
...
2.漢字音典中部分字表經過修改，涉及部分音值和音類，與字表出處存在一些差異。若有未注明的地方，敬請諒解。引用資料時務必查閱原始字表或資料出處。

3.漢字音典中大部分字表由愛好者獨立製作；如某方言點的漢字讀音存在問題，歡迎向漢字音典項目組或相應字表製作者反映。



## 附錄：分區方案

漢字音典提供分多種區方案，以便搜尋、整理與歸類。目前内置兩種分區方案，分別為：**地圖集二分區、「音典」分區。**

● **地圖集二分區**為預設分區，基本依據《中國語言地圖集 第2版 汉語方言卷（2012）》的相關文字說明劃分；對於地圖集中未明確提及的方言，則按相近標準歸類。

● **「音典」分區**為漢字音典**部分成員**為**自身使用****檢索、整理與歸類****的便利**而自行建立的分區方案，為藉助「漢字音典」平臺發佈的**私人分區**。

● **陳邡分區**為私人分區方案，本項目原則上不作說明。由於年久失修，暫時隱藏。
...
**1.****「音典」分區****僅與****「****漢字音典****」****的簡稱相同，亦可稱****「****新概念****」****分區、****「****YD****」分區****，與****「****漢字音典****」****的主要工作無關。**

2.「音典」分區大體上意在反映方言的系屬及親緣關係；但由於譜系關係與實際分區在細節上難以完全一致，加之出於管理成本與搜尋便利的考量，部分分區並未完全遵循譜系分類原則。**「音典」分區僅為對方言劃分的一種實踐方式，****不可能也做不到最好。**

3.**「音典」分區**由各個方言區維護人的方案拼合而成，這點與《中國語言地圖集》類似。因各方言區的劃分者不同，分區顆粒度亦不盡一致。**除相應分區****維護****者外，任何人均不得代表「音典」分區制定者對該分區作權威性解釋。**

4.**「音典」分區****僅為部分****「****漢字音典****」****成員為使用便利產生的分區方案，屬於私人分區，不成熟且無權威效力，禁止將****「音典」分區****用於正式出版物上。****「音典」分區與《中國語言地圖集》無隸屬或權威對應關係。**

### 

### 關於分區：

**漢字音典尊重不同的分區方案。**分區無論優劣，僅為目的考慮。任何人均可以有自己的意見與方案。語音、詞匯、語法；共時形態、親緣關係；調查便利、圈定範圍……每種劃分都有其意義，言之有理即可。**分區不是目的，漢字音典本身也并不在意分區。做好語言的田野調查和資料整理才是最重要的。關注好語言本身。**——以上爲@Resound的見解。
...
● 參考資料：[MCPDict-華北分區20250921](https://docs.qq.com/sheet/DTVFPdk9MeGNiT3Fo?tab=000001)、[（拟）音典河北三级分区标准](https://www.zhihu.com/pin/2063692534799505320?native=1&scene=share&utm_psn=2067601385013743669)
