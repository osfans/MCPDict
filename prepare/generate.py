...
HEADS = [
  ...
  ('cmn_xn_xzzp','象州中平話', '象州中平', '#C600FF', None, None, "版本：1.1 (2021-10-14)<br>來源：<u>清竮塵</u>整理自唐七元、仇浩揚《廣西象州中平官話同音字匯》","44 1 1a 陰平 ꜀,31 2 1b 陽平 ꜁,54 3 2 上 ꜂,,35 5 3a 陰去 ꜄,213 6 3b 陽去 ꜅"),
  ...
  ('cmn_hy_hc_yz', '揚州話', '揚州', '#800080', None,None, "更新：2021-10-14<br>來源：<u>慕禃</u>", "21 1 1a 陰平 ꜀,35 2 1b 陽平 ꜁,42 3 2 上 ꜂,,55 5 3 去 ꜄,,4 7 4 入 ꜆,2 8 4b 陽入 ꜇"),
  ...
  ('wuu_pl_td', '包場正餘餘東話', '包場-餘東', '#0000FF', None, None, "更新：2021-10-14<br>來源：<u>正心修身</u>基於呂四方言研究及海門縣方言志修改整理擴充而成","44 1 1a 陰平 ꜀,113 2 1b 陽平 ꜁,51 3 2a 陰上 ꜂,231 4 2b 陽上 ꜃,334 5 3a 陰去 ꜄,213 6 3b 陽去 ꜅,34 7 4a 陰入 ꜆,23 8a 4b 陽入 ꜇,5 8b 4c 次濁入 ꜁"),
  ...
  ('wuu_oj_yj', '永嘉話', '永嘉', '#0000FF', None, None, "更新：2021-10-14<br>來源：《永嘉縣志》轉錄人落橙","44 1 1a 陰平 ꜀,31 2 1b 陽平 ꜁,45 3 2a 陰上 ꜂,34 4 2b 陽上 ꜃,52 5 3a 陰去 ꜄,22 6 3b 陽去 ꜅,323 7 4a 陰入 ꜆,212 8 4b 陽入 ꜇"),
  ...
  ('nan_cs_cz', '潮州話', '潮州', '#FF6600', None, None, "版本：V1.0 (2021-10-13)<br>來源：<u>Kiattan</u>","33 1 1a 陰平 ꜀,55 2 1b 陽平 ꜁,52 3 2a 陰上 ꜂,25 4 2b 陽上 ꜃,213 5 3a 陰去 ꜄,11 6 3b 陽去 ꜅,2 7 4a 陰入 ꜆,54 8 4b 陽入 ꜇"),
  ...
  ('cdo_cnqk', '蒼南錢庫蠻話', '蒼南錢庫', '#DB7093', None, None, "更新：2021-10-14<br>來源：<u>阿纓</u>","44 1 1a 陰平 ꜀,213 2 1b 陽平 ꜁,45 3 2 上 ꜂,,41 5 3a 陰去 ꜄,22 6 3b 陽去 ꜅,4 7 4a 陰入 ꜆,2 8 4b 陽入 ꜇"),
...
#cz
d.clear()
for line in open("方言调查字表 1.0（潮州）(3600字).tsv"):
  fs = [i.strip('" ') for i in line.strip('\n').split('\t')]
