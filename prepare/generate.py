...
HEADS = [
  ...
  ('cmn_zho_qagj','秦安郭嘉話', '秦安縣郭嘉', '#FF00C7', None, None, "更新：2021-10-30<br>來源：<u>清竮塵</u>整理自李小潔《甘肅秦安縣郭嘉方言語音研究》","113 1 1 平 ꜀,,53 3 2 上 ꜂,,44 5 3 去 ꜄"),
  ...
  ('cmn_hy_hc_yz', '揚州話', '揚州', '#800080', None,None, "版本：V2.0 (2021-11-05)<br>來源：<u>慕禃</u>", "21 1 1a 陰平 ꜀,35 2 1b 陽平 ꜁,42 3 2 上 ꜂,,55 5 3 去 ꜄,,4 7 4 入 ꜆,2 8 4b 陽入 ꜇"),
  ...
  ('cmn_hy_hc_bf', '阜寧話', '阜寧', '#800080', None, None, "版本：V3.1 (2021-10-24)<br>來源：<u>清竮塵</u>整理自《濱海縣志》","52 1 1a 陰平 ꜀,25 2 1b 陽平 ꜁,211 3 2 上 ꜂,,334 5 3 去 ꜄,,4 7 4 入 ꜆"),
  ...
  ('wuu_pl_td', '包場正餘餘東話', '包場-餘東', '#0000FF', None, None, "更新：2021-11-05<br>來源：<u>正心修身</u>基於呂四方言研究及海門縣方言志修改整理擴充而成<br>說明：本文所紀錄的通東（包場-餘東）屬於太湖吳語的毗陵小片，是帶有吳淮邊界特徵的特殊吳方言，以通東地區的中間地帶的包場鎮餘東鎮爲代表。通東地區（古通州東鄉）的方言具有高度的一致性。不同鄉鎮之間方言區別，主要體現在聲調歸派以及調值與連讀變調上，部分點直接音韻也有細微差別，內部大致可分爲三路口音：以呂四（呂泗）爲代表的東路口音，以包場餘東爲代表的中路口音，以四甲爲代表的西路口音，以及位於如皋境內的南場話。呂四以及四甲擁有現成字表，餘東-包場是由正心修身綜合整理該兩字表資料，並根據田調重新記音考訂本字整合而成。<br>以下講述 包場-餘東 呂四 四甲 三地音系差別<br>包場-餘東音系無獨立ɚ韻，凡呂四字表中ɚ韻字一律併入ɛ。<br>包場-餘東音大部分幫組麻韻讀如ɤᵚ韻，如馬ʔmɤᵚ③ 區別於四甲mo③<br>包場-餘東音次濁平一律入陰去 區別呂四沿iɪ̃②≠宴iɪ̃⑤ 或四甲次濁平一律讀陽平<br>包場-餘東音有獨立次濁入調⑧B 5ˀ 區別於四甲讀入陽入調⑧5ˀ，呂四讀入陰入調34ˀ。<br>以上爲主要音系差別<br>原字表材料均僅有29個聲母<br>p pʰ b m f v t tʰ d n l ts tsʰ dz s z tɕ tɕʰ dʑ ɕ ʑ k kʰ ɡ ŋ x ɣ 0<br>正心修身根據實際發音將接撮口tɕ組聲母單獨列出記爲tʃ，舌面細音在接撮口呼時具有強烈的舌葉色彩，於原接齊齒呼的tɕ組聽感上存在較大差異，新派的齊齒呼tɕ組發生女國音現象併入ts組，如今讀如tsiŋ乃至tsəŋ 先憲讀如siɪ̃，接撮口呼的tɕ組音則舌葉色彩加劇，如虛讀如ʃʯ，新派的iⱼ韻有兩個演變方向一爲併入ɿ導致雞=資=tsɿ，二爲舌葉化讀如ʅ 雞tʃʅ≠資tsɿ，因爲影響到韻的分合，字表採用了較爲老派的發音tɕiⱼ，並未將iⱼ韻tɕ組併入tʃ或是ts，又正心修身將陽調零聲母單獨列出記作ɦ（通東陽調零聲母與上海陽調匣母性質相同），故聲母總數爲36個，比前字表記音多出tʃ tʃʰ dʒ ʃ ʒ ɲ ɦ幾個聲母。其他韻母也根據實際發音進行了記音調整，使用者可以通過記音對比自行發現。<br>另注：通東話的a韻字在不同聲母後有不同變體在軟齶音後爲a，在雙脣音及舌尖音後爲aɐ̥（帶有強烈的央後元音色彩）,在接i介音時實際發音爲iä，字表記音中一律記作a，並沒有根據實際發音單列，需要注意。","44 1 1a 陰平 ꜀,113 2 1b 陽平 ꜁,51 3 2a 陰上 ꜂,231 4 2b 陽上 ꜃,334 5 3a 陰去 ꜄,213 6 3b 陽去 ꜅,34 7 4a 陰入 ꜆,23 8a 4b 陽入 ꜇,5 8b 4c 次濁入 ꜁"),
  ('wuu_pl_jj', '靖江話', '靖江', '#0000FF', None, None, "更新：2021-09-25<br>來源：江蘇靖江方言同音字彙，有一定修改，轉錄者<u>落橙</u>","433 1 1a 陰平 ꜀,223 2 1b 陽平 ꜁,334 3 2 上 ꜂,,51 5 3a 陰去 ꜄,31 6 3b 陽去 ꜅,55 7 4a 陰入 ꜆,34 8a 4b 陽入 ꜇"),
  ('wuu_pl_jt', '金壇話', '金壇', '#0000FF', None, None, "更新：2021-10-30<br>來源：金壇縣志，轉錄者<u>正心修身</u>","434 1 1a 陰平 ꜀,31 2 1b 陽平 ꜁,44 3 2a 陰上 ꜂,21 4 2b 陽上 ꜃,55 5 3a 陰去 ꜄,213 6 3b 陽去 ꜅,4 7 4a 陰入 ꜆,2 8a 4b 陽入 ꜇"),
  ('wuu_th_sz', '蘇州話', '蘇州', '#0000FF', '吳語學堂（蘇州）', "https://www.wugniu.com/search?table=suzhou_zi&char=%s", "版本：墳派4.0 (2021-11-03)、翹舌2.5<br>來源：<a href=https://github.com/NGLI/rime-wugniu_soutseu>蘇州吳語拼音輸入方案</a>、一百年前的蘇州話、鄉音字類<br>說明：灰色的爲老派翹舌音，是樛木整理自《一百年前的蘇州話》、《鄉音字類》，加*的漢字表示[ʐ][dʐ]歸屬、陽上陽去歸屬缺乏直接資料，以區分這兩者的蘇州行政區劃內的方吳語爲基準。對於《一百年前的蘇州話》有而《鄉音字類》中沒有的字，因《一百年前的蘇州話》記音不含聲調，則其聲調以今音爲準。","44 1 1a 陰平 ꜀,223 2 1b 陽平 ꜁,51 3 2 上 ꜂,31 4 2b 陽上 ꜃,523 5 3a 陰去 ꜄,231 6 3b 陽去 ꜅,4 7 4a 陰入 ꜆,23 8 4b 陽入 ꜇"),
  ...
  ('gan_ygyt', '餘干玉亭話', '餘干玉亭', '#20B2AA', None, None, "更新：2021-10-06<br>來源：由Pekkhak（啵啵）整理自陳昌儀《餘干方言同音字彙》及陳昌儀《贛方言概要》<br>說明：餘干方言入聲韻在發了塞音尾之後，經過短暫的休止，又有一個同部位的鼻音。入聲韻的兩個部位都有自己的調值。","33 1 1a 陰平 ꜀,25 2 1b 陽平 ꜁,213 3 2 上 ꜂,,45 5 3a 陰去 ꜄,23 6 3b 陽去 ꜅,104 7 4a 陰入 ꜆,101 8 4b 陽入 ꜇"),
  ...
  ('nan_cs_rp', '饒平話', '饒平', '#FF6600', None, None, "版本：V2.3 (2021-10-29)<br>來源：<u>四方麻東</u>","33 1 1a 陰平 ꜀,55 2 1b 陽平 ꜁,51 3 2a 陰上 ꜂,25 4 2b 陽上 ꜃,212 5 3a 陰去 ꜄,21 6 3b 陽去 ꜅,2 7 4a 陰入 ꜆,54 8 4b 陽入 ꜇"),
  ('nan_cs_rpxf', '饒平新豐話', '饒平新豐', '#FF6600', None, None, "版本：V1.3 (2021-10-29)<br>來源：<u>四方麻東</u>","34 1 1a 陰平 ꜀,55 2 1b 陽平 ꜁,52 3 2a 陰上 ꜂,25 4 2b 陽上 ꜃,212 5 3a 陰去 ꜄,22 6 3b 陽去 ꜅,32 7 4a 陰入 ꜆,54 8 4b 陽入 ꜇"),
...
#fn
d.clear()
for line in open("阜寧同音字表3.1.tsv"):
  line = line.strip().replace('"','').replace(' ','')
  if not line: continue
  if line.startswith("#"):
    ym = line[1:].split()[0]
...
d.clear()
firstline = False
for filename in ("苏州话翘舌音字表2.5.tsv", "与今音有区别的坟派读音字表(苏州话)4.0.tsv"):
  firstline = False
...
#nan_cs_rp
d.clear()
for line in open("方言调查字表（闽-饶平）2.3.tsv"):
  fs = [i.strip('" ') for i in line.strip('\n').split('\t')]
  hz,py,yb,zs = fs[:4]
  if not yb: continue
  sd = py[-1]
...
#nan_cs_rpxf
d.clear()
for line in open("方言调查字表（闽-饶平新丰）1.3.tsv"):
  fs = [i.strip('" ') for i in line.strip('\n').split('\t')]
  hz,py,yb,zs = fs[:4]
  if not yb: continue
  sd = py[-1]
