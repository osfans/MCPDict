...
class 表(_表):
	...
	韻擬 = {'音': 'in', '隨': 'ɐi', '泉': 'ᴇ', '更': 'aŋ', '何': 'ʊ', '法': 'aʔ', '畫': 'ɑʔ', '一': 'ieʔ', '翻': 'æ', '查': 'o', '諸': 'y', '聲': 'ən', '要': 'ɐɯ', '宜': 'i', '諧': 'ᴀ', '俗': 'oʔ', '從': 'oŋ', '吾': 'u', '方': 'ɑŋ', '言': 'ie', '求': 'ɤɯ', '而': 'ɿ', '各': 'ɔʔ', '得': 'əʔ'}
	調擬 = {"平": 1, "上" : 3, "去": 5, "入": 7}
	調序 = "平上去"
	聲 = ""
	韻 = ""
	...
	def 擬音(自):
		...
		音標 = re.sub("([ʒʃ]ʰ?)ɿ", "\\1ʅ", 音標).replace("lɿ", "l\u030D")
		return f"{音標}/{音}"
