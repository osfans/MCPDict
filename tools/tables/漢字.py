...
　　本程序將上百種語言（方言）的漢字讀音集成於本地數據庫，使用國際音標注音，可比較各語言的異同，也能給語言學習者提供有限的幫助。方言分片以《中國語言地圖集》（第二版）为主。<br>
　　本程序收錄了統一碼16.0全部漢字（不包含部首及兼容區漢字）、〇（同“星”或“零”）、□（有音無字、本字不明）。支持形音義等多種查詢方式，可輸入𰻞（漢字）、30EDE（統一碼）、biang2（普通話拼音，音節末尾的“?”可匹配任何聲調）、43（總筆畫數）、辵39（部首餘筆），查到“𰻞”字。也可選擇兩分、五筆畫等形碼進行查詢，亦可選擇說文解字、康熙字典、漢語大字典、古音匯纂等通過釋義中出現的詞語搜索到相應的漢字。"""
